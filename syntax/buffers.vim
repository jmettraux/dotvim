...
syn match bufFilename '\v(^|\/)@<=[^|\/]+( |$)' contained contains=bufLineAndRegister
syn match bufPath '\v[^|]+' contained contains=bufBranch,bufFilename
